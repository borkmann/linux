			    ...
			    u8 opcode)
{
	...
	case BPF_JSLT:
		...
		/* If this is true then we know the maximum val is val - 1,
		 * otherwise we know the min val is val.
		 */
	...
	case BPF_JSLE:
		...
		/* If this is true then we know the maximum value is val,
		 * otherwise we know the mimimum value is val + 1.
		 */
